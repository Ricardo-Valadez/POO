...
namespace ValadezLeal_U6
{
    class Program
    {
        ...
        public class Alumnos
        {
            ...
            public void CrearArchivo(string Archivo)
            {
                ...
                try
                {
                    ...
                    do
                    {
                        ...
                        Console.Write("Calificacion Primera Unidad: ");
                        Calificacion1 = Single.Parse(Console.ReadLine());
                        Console.Write("Calificacion Segunda Unidad: ");
                        Calificacion2 = Single.Parse(Console.ReadLine());
                        Console.Write("Calificacion Tercera Unidad: ");
                        ...
                        Rep = Char.ToUpper(Char.Parse(Console.ReadLine()));
                ...
                catch (FormatException F)
                {
                    ...
                    Console.WriteLine("Ruta del error: " + F.StackTrace);
                    Console.WriteLine("Presione enter para continuar...");
                    Console.ReadKey();
                }
                catch (ArgumentException A)
                {
                    Console.WriteLine("Mensaje del Error: " + A.Message);
                    Console.WriteLine("Ruta del Error: " + A.StackTrace);
                }
            ...
            ~Alumnos()
            {
                Console.WriteLine("\nMemoria Liberada Objeto Alumnos...");
